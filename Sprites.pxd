...
# @cython.nonecheck(False)
# @cython.cdivision(True)
# cdef class AbstractGroup(obj):
#
#     cpdef list sprites(self)
#
#     cpdef void add_internal(self, sprite)
#
#     cpdef void remove_internal(self, obj sprite)
#
#     cpdef bint has_internal(self, obj sprite)
#
#     cpdef copy(self)
#
#     cpdef void update(self, args=*)
#
#     cpdef draw(self, obj surface)
#
#     cpdef void clear(self, obj surface, obj bgd)
#
